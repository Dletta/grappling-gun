...
var Faye_NodeAdapter = Faye_Class({
    ...
    pingTimer = setInterval(function() {
      ...
      if(canPing) {
        timeoutTimer = setTimeout(function() {
          let serializedClientId;
          try {
            serializedClientId = Faye.toJSON(clientId);
          } catch (err) {
            serializedClientId = '[Object]';
          }
          self.warn("Client timeout on ping: " + serializedClientId, {
            request: request
          });
  ...
  _returnError: function(response, error) {
    ...
    // Extra object is based off of the Raven additional data, https://docs.sentry.io/clients/node/usage/#raven-node-additional-data
    this.error(message, {
      extra: error.extra,
      tags: error.tags,
